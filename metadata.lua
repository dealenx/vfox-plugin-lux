...
--- Plugin description
PLUGIN.description = "vfox plugin for Lux - A fast and efficient Lua package manager"
...
PLUGIN.notes = {
    ...
    "On Windows, you may need to enable a x64 hosted MSVC toolset for full functionality.",
}
